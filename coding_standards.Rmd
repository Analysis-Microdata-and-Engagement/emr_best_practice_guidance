...
These are the tools that all analysts in EMR should implement.

1. Version Control with Git and Gitlab/GitHub
2. Standard project structure
3. Good naming
4. Documentation
5. Functional Programming using Python Package
6. Code Testing

All these tools are supported in DAP.
...
These Resource blocks are hyperlinks, click on them to access the resource.

::: {.accordion}
## 1 - Version Control with Git

<span class="link">`r learning_icon` [Version control](https://best-practice-and-impact.github.io/qa-of-code-guidance/version_control.html) </span>

- Git- version control system, local to your laptop
- GitLab- hosts Git projects. Code available to team and can be made available to people in ONS
- GitHub- similar to GitLab but code available to world- completely open
...
<span class="link">`r learning_icon` [EMR Project Template ](https://github.com/Analysis-Microdata-and-Engagement/emr_project_template) </span>
...
<span class="link">`r learning_icon` [Good Naming ](https://best-practice-and-impact.github.io/qa-of-code-guidance/core_programming.html#naming) </span>
...
<span class="link">`r learning_icon` [Code Documentation ](https://best-practice-and-impact.github.io/qa-of-code-guidance/code_documentation.html) </span>

<span class="link">`r learning_icon` [Project Documentation ](https://best-practice-and-impact.github.io/qa-of-code-guidance/project_documentation.html) </span>
...
<span class="link">`r learning_icon` [Modular Analysis ](https://best-practice-and-impact.github.io/qa-of-code-guidance/project_structure.html) </span>
...
<span class="link">`r learning_icon` [Testing ](https://best-practice-and-impact.github.io/qa-of-code-guidance/testing_code.html) </span>

<span class="link">`r learning_icon` [Pytest ](https://docs.pytest.org/en/6.2.x/) </span>
